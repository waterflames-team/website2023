...
<template>
  <PageWrapper>
    ...
    <PageBody>
      <PageSection>
        <p>WaterFlames 是一个开源团队，2019 年 8 月创建。</p>
        <p>我们基于开源社区，制作了几个开源项目。</p>
        <p>
      ...
      <PageSection class="flex flex-col gap-20">
        ...
        >
          <div class="text-lg">
            <p>如果你想要支持我们，欢迎给我们赞助。</p>
            <p>每年服务器、域名、cdn等等云资源都会耗费我们很多钱，</p>
            <p>我们迫切需要更多的赞助帮助我们继续支撑团队开销，</p>
            <p>谢谢你。</p>
          </div>
        </PagePeople>
      </PageSection>
